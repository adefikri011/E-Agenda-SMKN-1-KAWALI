...
@section('content')
    <div class="bg-white rounded-xl shadow-md p-5 mb-6">
        <div class="flex flex-col md:flex-row md:items-center justify-between mb-6">
            <div>
                <h1 class="text-2xl font-bold text-gray-900 mb-1">Data Guru</h1>
        ...
        <table class="w-full">
            <thead class="bg-gray-50 border-b border-gray-200">
                <tr>
                    ...
                    <th class="py-3 px-5 text-left text-xs font-semibold text-gray-500 uppercase">Nama Guru</th>
                    <th class="py-3 px-5 text-left text-xs font-semibold text-gray-500 uppercase">NIP</th>
                    <th class="py-3 px-5 text-left text-xs font-semibold text-gray-500 uppercase">Email</th>
